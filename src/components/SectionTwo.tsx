...
function SectionOne() {
    ...
    return (
        <div className='flex flex-col items-center justify-center h-screen w-full bg-gray-400 space-y-5'>

            <h1 className='text-5xl text-center'>Lorem ipsum dolor sit amet.</h1>
